...
$etudiant_id = $_GET['etudiant_id'] ?? 1;
$nom_etudiant = "";
...
else {$header = 'Filtre des produits de : ' . $nom_etudiant;}
...
<div class="grid grid-cols-4 gap-1">
    <?php foreach ($produits as $produit): ?>
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white font-size:24px"><?php echo $produit['nom'] ?></h5>
                    </a>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo $produit['prix'] . " " . $produit['devise'] ?></span>
